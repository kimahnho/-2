           ...
           <div className="space-y-3">
              ...
              <div className="flex p-1 bg-gray-100 rounded-lg gap-1">
                <button 
                  ...
                  className={`flex-1 py-1 text-xs font-medium rounded-md flex items-center justify-center gap-1 transition-all ${
                    activeImageTab === 'upload' ? 'bg-white shadow-sm text-[#5500FF]' : 'text-gray-500 hover:text-gray-700'
                  }`}
                >
                ...
                <button 
                  ...
                  className={`flex-1 py-1 text-xs font-medium rounded-md flex items-center justify-center gap-1 transition-all ${
                    activeImageTab === 'ai' ? 'bg-white shadow-sm text-[#5500FF]' : 'text-gray-500 hover:text-gray-700'
                  }`}
                >
              ...
              {PRESET_COLORS.map(color => {
                ...
                return (
                  <button
                    ...
                    className={`w-7 h-7 rounded-full border border-gray-200 shadow-sm transition-transform hover:scale-110 active:scale-95 ${
                      currentColor === color ? 'ring-2 ring-offset-2 ring-[#5500FF]' : ''
                    }`}
