            ...
            {!isAACCard && (
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button onClick={onUploadImage} className="flex-1 py-2 text-xs font-bold text-gray-700 border border-gray-300 rounded hover:bg-gray-50 flex items-center justify-center gap-2">
                    <Upload className="w-3.5 h-3.5" /> 업로드
                  </button>
                  <button onClick={() => activeImageTab === 'ai' ? setActiveImageTab('upload') : setActiveImageTab('ai')} className="flex-1 py-2 text-xs font-bold text-[#5500FF] border border-[#5500FF] rounded hover:bg-[#5500FF]/5 flex items-center justify-center gap-2">
